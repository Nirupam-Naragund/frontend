...
4)Similarly the text on the button is also conditionally rendered based on the value of isLoggedIn If isLoggedIn is true the button text is Logout  otherwise its Login <br /><br />
